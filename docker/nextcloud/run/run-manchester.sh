...
docker run \
	...
	-v /usr/portage:/usr/portage:ro \
        ...
        -v /mnt/full-data/vols/nextcloud-config/php/fpm-php7.2/fpm.d/www.conf:/etc/php/fpm-php7.2/fpm.d/www.conf:ro \
        -v /mnt/full-data/vols/nextcloud-config/php/fpm-php7.2/php.ini:/etc/php/fpm-php7.2/php.ini:ro \
